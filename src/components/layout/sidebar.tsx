            ...
            <CardContent className="p-4 space-y-4">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <Label htmlFor="ports-weight">{tSidebar('openPorts')}</Label>
                  <span className="text-xs text-muted-foreground">{weights.openPorts}/100</span>
                </div>
                <Progress value={weights.openPorts} id="ports-weight" />
              </div>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <Label htmlFor="services-weight">{tSidebar('serviceVersions')}</Label>
                   <span className="text-xs text-muted-foreground">{weights.serviceVersions}/100</span>
                </div>
                <Progress value={weights.serviceVersions} id="services-weight" />
              </div>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <Label htmlFor="nse-weight">{tSidebar('nseScripts')}</Label>
                  <span className="text-xs text-muted-foreground">{weights.nseScripts}/100</span>
                </div>
                <Progress value={weights.nseScripts} id="nse-weight" />
              </div>
            </CardContent>
          </Card>
        </SidebarGroup>
